...
"""4. This function prints out a multiplication table (where each number is the result of multiplying the first number of its row by the number at the top of its column).\nFill in the blanks so that calling multiplication_table(1, 3) will print out:\n
1 2 3 
...
# 5. The counter function counts down from start to stop when start is bigger than stop, and counts up from start to stop otherwise.\nFill in the blanks to make this work correctly.\n
...
def decade_counter():
	while year < 50:
		year += 10
	return year\n
A.: Failure to initialize variables"""
